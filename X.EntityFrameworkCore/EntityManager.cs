...
namespace X.EntityFrameworkCore
{
    ...
    public class EntityManager : IEntityManager
    {
        ...
        public virtual void Initialize()
        {
           ...
           //todo     list.AddIfNotExist(new FunctionConfiguration(), m => m.EntityType.IsBaseOn<IFunction>());
                dict[key] = list.ToArray();
            }
        ...
        //todo private class FunctionConfiguration : EntityTypeConfigurationBase<Function, Guid>
        //{
        //    /// <summary>
        //    /// 重写以实现实体类型各个属性的数据库配置
        //    /// </summary>
