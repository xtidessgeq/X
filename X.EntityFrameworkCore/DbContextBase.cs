...
namespace X.EntityFrameworkCore
{
    ...
    public abstract class DbContextBase : DbContext, IDbContext
    {
        ...
        {
         //TODO   IList<AuditEntityEntry> auditEntities = new List<AuditEntityEntry>();
            if (_osharpDbOptions?.AuditEntityEnabled == true)
            {
                // TODO     IAuditEntityProvider auditEntityProvider = _serviceProvider.GetService<IAuditEntityProvider>();
                // TODO  auditEntities = auditEntityProvider?.GetAuditEntities(this)?.ToList();
            }
